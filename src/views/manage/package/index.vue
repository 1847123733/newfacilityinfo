...
<!--      </el-form-item>-->
    ...
    <el-table v-loading="loading" :data="packageList" @selection-change="handleSelectionChange" border>
      <el-table-column type="selection" width="55" align="center" />
      <el-table-column label="所属产品名称" align="center" prop="productName" show-overflow-tooltip/>
<!--      <el-table-column label="主键" align="center" prop="packageId" />-->
      <el-table-column label="模块编号" align="center" prop="packageCode" show-overflow-tooltip/>
      <el-table-column label="模块名称" align="center" prop="packageName" show-overflow-tooltip/>
