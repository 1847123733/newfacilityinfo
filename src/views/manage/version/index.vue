...
<!--      <el-table-column label="主键" align="center" prop="versionId" />-->
      ...
      <el-table-column label="版本号" align="center" prop="versionCode" width="70" show-overflow-tooltip />
      <el-table-column label="版本名称" align="center" prop="versionName"  show-overflow-tooltip/>
      <el-table-column label="升级改动点描述" align="center" prop="updateDescribe"  show-overflow-tooltip/>
      <el-table-column label="下载地址" align="center" prop="softwareUrl"  width="160"  show-overflow-tooltip/>
      <el-table-column label="文件md5值" align="center" prop="softwareMd5" width="160" show-overflow-tooltip/>
      <el-table-column label="产品名称" align="center" prop="productName" show-overflow-tooltip/>
      <el-table-column label="升级状态" align="center" prop="visible"  width="110" show-overflow-tooltip>
        <template slot-scope="scope">
          <el-tag type="success" v-if="scope.row.visible === '1'">允许升级</el-tag>
          <el-tag type="danger" v-if="scope.row.visible === '0'">不允许升级</el-tag>
        </template>
      </el-table-column>
      <el-table-column label="版本状态" align="center" prop="status" width="100" show-overflow-tooltip >
        <template slot-scope="scope">
      ...
      <el-table-column label="操作" align="center" width="210" show-overflow-tooltip class-name="small-padding fixed-width">
        <template slot-scope="scope">
          <el-button
            size="mini"
            type="text"
...
export default {
  ...
  methods: {
    ...
    upgradeEquipment(row) {
      ...
      console.log(row.productId,'升级设备页面')
