...
<!--        />-->
    ...
    <el-table v-loading="loading" :data="hardwareList" @selection-change="handleSelectionChange" border>
...
<!--      <el-table-column label="产品主键" align="center" prop="productId" />-->
      <el-table-column label="产品名字" align="center" prop="productName" show-overflow-tooltip />
      <el-table-column label="硬件编码" align="center" prop="hardwareCode" show-overflow-tooltip/>
      <el-table-column label="硬件名称" align="center" prop="hardwareName" show-overflow-tooltip/>
