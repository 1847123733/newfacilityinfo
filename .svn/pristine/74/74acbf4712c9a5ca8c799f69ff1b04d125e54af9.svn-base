<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="dubiousinfoList" @selection-change="handleSelectionChange" border >
      <el-table-column type="selection" width="55" align="center" />
      <el-table-column label="序号" align="center" type="index" width="50" />
<!--      <el-table-column label="主键" align="center" prop="dubiousId" />-->
      <el-table-column label="面部照片地址" align="center" prop="facephotoUrl" width="200" show-overflow-tooltip/>
      <el-table-column label="来访时间" align="center" prop="actionTime" width="180" show-overflow-tooltip>
        <template slot-scope="scope">
          <span>{{ parseTime(scope.row.actionTime, '{y}-{m}-{d}') }}</span>
        </template>
      </el-table-column>
      <el-table-column label="详细地址" align="center" prop="actionAddress"  show-overflow-tooltip/>
